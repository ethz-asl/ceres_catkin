...
INSTALL_SPACE=$1
SUITESPARSE_INCLUDE=$2
SUITESPARSE_LIB=$3

echo "SS_INC: $SUITESPARSE_INCLUDE"
echo "SS_LIB: $SUITESPARSE_LIB"
...
cmake -DCMAKE_CXX_FLAGS=-fPIC -DGFLAGS=ON -DGFLAGS_LIBRARY=$PACKAGE_DIR/$GFLAGS_PATH/.libs/libgflags.a \
      ...
      -DSUITESPARSE_INCLUDE_DIR_HINTS=$SUITESPARSE_INCLUDE \
      -DSUITESPARSE_LIBRARY_DIR_HINTS=$SUITESPARSE_LIB \
